...
libxml.Document.prototype.search = function(cssSelector, ns) {
    return this.find(css2xpath(cssSelector), ns);
};

libxml.Document.prototype.fetch = function(cssSelector, ns) {
    return this.search(cssSelector, ns)[0];
};

libxml.Element.prototype.search = function(cssSelector, ns) {
    return this.find("." + css2xpath(cssSelector), ns);
};

libxml.Element.prototype.fetch = function(cssSelector, ns) {
    return this.search(cssSelector, ns)[0];
};
